...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue function from PersonQueue class inserting new person at the beginning of list instead of its end
    // Fix: changed Enqueue function to use ".push(person)" in place of (.insert(0, person))
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: There is no logic to handle infinite turns (in this case 0 turns)
    // Fix: Added an if statement that handles infinite turns to the GetNextPerson function
    ...
    // Defect(s) Found: There is no logic to handle infinite  (in this case negative turns)
    // Fix: Added an if statement that handles infinite turns to the GetNextPerson function
